...
const ProfileContent = function ProfileContent() {
  ...
  const {user, handleUser} = useContext(User)
  const {
    register,
    handleSubmit,
  ...
  const {reFetch} = useContext(Notifications)
    ...
    return (
      <form onSubmit={handleSubmit(onSubmit)} className="my-container">
        <div className="flex flex-col lg:flex-row  gap-5 my-14">
          <div className="px-10 py-10 bg-gray-100 dark:bg-[#1A2230]  rounded-lg flex flex-col justify-center gap-3">
            ...
            <div className="bg-[#E9EDF4] p-3 text-center rounded-md">
          ...
          <div className="py-10 bg-gray-100 dark:bg-[#1A2230] rounded-lg ">
