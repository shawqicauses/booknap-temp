  ...
  return (
    <div className="flex flex-col gap-4 mb-10">
      <div className="bg-gray-100 rounded-lg p-4">
        ...
        <p className="body text-black">{hotelData.about}</p>
      </div>
      <div className="flex gap-4">
        <div className="bg-gray-100 rounded-lg p-4 flex-grow-[2]">
          <div className="flex gap-4 items-center mb-2">
            <GrLocation className="w-5 h-5 text-[#2F5597]" />
            <span className="heading-3 text-xl-2">Location</span>
          </div>
          <div className="flex justify-between">
            <span>{hotelData.contry}</span>
            <Link
        ...
        <div className="bg-gray-100 rounded-lg p-4 flex-grow-[3]">
          <div className="flex gap-4 items-center mb-2">
      ...
      <div className="bg-gray-100 rounded-lg p-4 h-auto">
        <div className="flex gap-4 mb-3">
          <FaRegImage className="w-5 h-5 text-[#2F5597]" />
          <span className="heading-3 text-xl-2">Galary</span>
        </div>
        <div className="grid grid-cols-4 grid-row-4 h-full gap-4">
          {hotelData.images.map((image, index) => (
            <div
              ...
              key={image.id}>
              <Image src={image.src} alt="image" fill className="!relative" />
            </div>
          ))}
